    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        ...
        <div class="row justify-content-end mb-2">
          <div class="col-xl-12">
            <form action="/helpdesk/authorize/create" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
              ...
              <div class="row justify-content-center mb-2">
                ...
                <div class="col-xl-3 mb-2">
                  <a href="/helpdesk/authorize" class="btn btn-sm btn-danger btn-block">
